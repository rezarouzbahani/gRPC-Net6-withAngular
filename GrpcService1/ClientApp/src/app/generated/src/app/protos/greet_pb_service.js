...
var src_app_protos_greet_pb = require("../../../src/app/protos/greet_pb");
...
Greeter.SayHello = {
  ...
  requestType: src_app_protos_greet_pb.HelloRequest,
  responseType: src_app_protos_greet_pb.HelloReply
};
